...
namespace kinematics {
  ...
  /// modules, \theta^o_1 in docs.
	...
	static const double L1 = 50.74;				///> Distance between wheel axes and the waist module (cm)
	static const double L2 = 10.98;				///> Distance between the waist module and the spine (cm)
	static const double L3 = 66.94;				///> Distance between the torso frame's origin and the bases of the arms
	static const double L4 = 28.06;				///> Arm link length between modules 0 and 2 (cm)
